...
Yes. I've used Net::HTTP for over a billion requests (literally) and now it's time to take it up a notch. libcurl is a very mature, stable and well tested project. ruby-curl is here to fetch the next billion requests.
